...
u1 = User.create!(username: "David Larson", first_name: "David", last_name: "Larson", password: "touchdown")
u2 = User.create!(username: "Bill Dobson", first_name: "Bill", last_name: "Dobson", password: "touchdown")
u3 = User.create!(username: "Rowen Morse", first_name: "Rowen", last_name: "Morse", password: "demopassword", profile_img_url: "http://res.cloudinary.com/durooeqnc/image/upload/c_thumb,h_180,q_100,r_30/a_0/v1484896604/pas4im6ogwi-joe-gardner_xf5ls3.jpg")
u4 = User.create!(username: "Steven Donald", first_name: "Steven", last_name: "Donald", password: "touchdown")
u5 = User.create!(username: "Donny Raymond", first_name: "Donny", last_name: "Raymond", password: "touchdown")
u6 = User.create!(username: "Josh Cole", first_name: "Josh", last_name: "Cole", password: "touchdown")
u7 = User.create!(username: "Ron Stevenson", first_name: "Ron", last_name: "Stevenson", password: "touchdown")
u8 = User.create!(username: "Victor Aston", password: "touchdown", first_name: "Victor", last_name: "Aston")
u9 = User.create!(username: "Quin Rollins", password: "touchdown", first_name: "Quin", last_name: "Rollins")
u10 = User.create!(username: "Vicky Winston", password: "touchdown", first_name: "Vicky", last_name: "Winston")
u11 = User.create!(username: "Carson Lee", password: "touchdown", first_name: "Carson", last_name: "Lee")
