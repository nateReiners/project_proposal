...
u3 = User.create!(username: "Ethan Morse", first_name: "Ethan", last_name: "Morse", password: "demopassword", profile_img_url: "https://res.cloudinary.com/durooeqnc/image/upload/c_fill,h_200/v1484900402/7xldgzjfx3s-i-m-priscilla_bn3c7f.jpg")
u4 = User.create!(username: "Stephanie Donald", first_name: "Stephanie", last_name: "Donald", password: "touchdown", profile_img_url: "https://res.cloudinary.com/durooeqnc/image/upload/c_lfill,g_face:center,w_180/v1484899073/hrzuzox1e6w-brooke-cagle_w4mkyi.jpg")
u5 = User.create!(username: "Donny Raymond", first_name: "Donny", last_name: "Raymond", password: "touchdown", profile_img_url: "http://res.cloudinary.com/durooeqnc/image/upload/c_fit,h_300/v1484914957/q7r-iezw1bu-nik-macmillan_p7ntwq.jpg")
u6 = User.create!(username: "Steve Cole", first_name: "Steve", last_name: "Cole", password: "touchdown", profile_img_url: "https://res.cloudinary.com/durooeqnc/image/upload/v1484897883/endregvcvam0o4a4vd2h.jpg")
u7 = User.create!(username: "Rachel Stevenson", first_name: "Rachel", last_name: "Stevenson", password: "touchdown", profile_img_url: "https://res.cloudinary.com/durooeqnc/image/upload/c_fill,g_face:center,w_180/v1484900276/fqeutmkyhwu-agberto-guimaraes_asqice.jpg")
u8 = User.create!(username: "Victor Aston", password: "touchdown", first_name: "Victor", last_name: "Aston", profile_img_url: "http://res.cloudinary.com/durooeqnc/image/upload/c_fit,h_300/v1484915302/sibvworyqs0-ayo-ogunseinde_tk1y7f.jpg")
u9 = User.create!(username: "Quin Rollins", password: "touchdown", first_name: "Quin", last_name: "Rollins", profile_img_url: "http://res.cloudinary.com/durooeqnc/image/upload/c_scale,h_300/v1484915227/pas4im6ogwi-joe-gardner_xf5ls3.jpg")
u10 = User.create!(username: "Vicky Winston", password: "touchdown", first_name: "Vicky", last_name: "Winston", profile_img_url: "http://res.cloudinary.com/durooeqnc/image/upload/c_fit,h_300/v1484915054/k36naecxvwu-henri-meilhac_dewbve.jpg")
