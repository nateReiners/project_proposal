...
p1 = Photo.create!(author_id: u2.id, img_url: "https://s-media-cache-ak0.pinimg.com/236x/75/a9/3b/75a93b93a36c273d29f06fc49210da94.jpg", title: "Title number 1")
...
f3 = Follow.create!(follower_id: u2, following_id: u3.id)
f4 = Follow.create!(follower_id: u2, following_id: u1.id)
